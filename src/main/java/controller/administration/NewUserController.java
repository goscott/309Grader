...
public class NewUserController {
    ...
    public void createUser() {
        ...
        else if ((!checkbox_show.isSelected() && password_masked.getText()
                .isEmpty())
                || (checkbox_show.isSelected() && password_plain_text.getText()
                        .isEmpty())) {
            error_message.setVisible(true);
        }
        ...
        //if user is not already in the db
            ...
            if (!checkbox_show.isSelected()) {
                users.addUser(
                        new User(first_name.getText(), last_name.getText(),
                                user_name.getText(), password_masked.getText(),
                                userType), true);
            }
                ...
                users.addUser(
                        new User(first_name.getText(), last_name.getText(),
                                user_name.getText(), password_plain_text
                                        .getText(), userType), true);
            }
