...
public class ResourceLoader {
	...
	public final static javafx.scene.paint.Color ERROR_RED = javafx.scene.paint.Color
			.web("#FE7E84");
	...
	public final static javafx.scene.paint.Color LINE_COLOR = javafx.scene.paint.Color
			.web("#03434B");
	/** The color of a bar in the histogram **/
	public final static javafx.scene.paint.Color BAR_COLOR = javafx.scene.paint.Color
			.web("#BC7BE9");
	/** The color of the histogram's background **/
	public final static javafx.scene.paint.Color BACKGROUND = javafx.scene.paint.Color
			.web("#CBEFF4");

	/** The program's icon, wich is displayed in the status bar of most popups **/
	public final static Image ICON = new Image(
			ResourceLoader.class.getResourceAsStream("GraderIcon.png"));
	/** The program's load screen **/
	public final static Image LOAD_SCREEN = new Image(
			ResourceLoader.class.getResourceAsStream("GraderLoadScreen.jpg"));
}
